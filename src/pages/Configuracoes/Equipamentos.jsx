  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-sm font-bold text-foreground">Equipamentos</p>
          <p className="text-xs text-muted-foreground">Cadastro de equipamentos</p>
        </div>
      </div>
      ...
      <div className="bg-card rounded-xl border border-border shadow-sm p-12 flex flex-col items-center justify-center gap-3 text-center">
        ...
        <p className="text-xs text-muted-foreground/70 max-w-xs">
          O cadastro de equipamentos estará disponível em breve.
        </p>
      </div>
    </div>
  );
...
export default function Equipamentos({ asTab = false }) {
  if (asTab) return <EquipamentosContent />;
